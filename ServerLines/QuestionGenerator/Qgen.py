...
def results2md(sents):
    all_md = []
    for s in sents:
        q_html = TABLE_TEMPLATE.substitute(question = s["Question"],ans1 = s["Options"],ans2 = s["Options"],ans3 = s["Options"])
        all_md.append(q_html)
    return '<br/><br/>'.join(all_md)
